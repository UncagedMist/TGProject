...
import tbc.techbytecare.kk.touristguideproject.Interface.Api;
import tbc.techbytecare.kk.touristguideproject.Model.Checksum;
import tbc.techbytecare.kk.touristguideproject.Model.Constants;
import tbc.techbytecare.kk.touristguideproject.Model.Paytm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                textViewPrice.setText(edtMoney.getText().toString());
            }
        });
