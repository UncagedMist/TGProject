...
import static tbc.techbytecare.kk.touristguideproject.Database.DBHelper.WALLET_COLUMN_CASH;
        ...
        try {
            ...
            if (bundle != null) {
                ...
                for (int i = 0; i < pdusObj.length; i++) {
                    ...
                    {
                        if(MoneyOrderActivity.getAppContext() == null)
                        {
                            PackageManager pm = context.getPackageManager();
                            Intent launchIntent = pm.getLaunchIntentForPackage("tbc.techbytecare.kk.touristguideproject");
                            context.startActivity(launchIntent);
                        }
                        else
                        {
                            MoneyOrderActivity.getAppContext().registerReceiver(
